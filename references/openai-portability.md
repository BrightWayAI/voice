# OpenAI portability contract — Writing Style
...
- ChatGPT desktop: enable the plugin in a chat, then ask naturally or use `@Writing Style <request>`.
...
Mail and publishing connectors are optional. Accept pasted samples and return copy-ready text when absent. Never send or publish automatically; style-file changes require user approval.
