...
Confirm `<config-root>/memory/me/voice.md` and (if applicable) `<config-root>/style-{medium}.md` exist. Confirm `<config-root>/plugins/comms.user-context.md` exists for the confidence threshold.
